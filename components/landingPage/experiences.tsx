                ...
                return (
                    <div className={styles.challenges}>
                        <div className={styles.heading}>
                            ...
                            <p>Participate in fair and purposeful games to improve, grow the ladder, achieve missions
                                and win cashprizes.</p>
                        </div>
                        <div className={styles.body}>
                            <div className={styles.icon}>
                                <ReactSVG src={'/images/icons/game-mode.svg'}/>
                ...
                return (
                    <div className={styles.skills}>
                        <div className={styles.heading}>
                            ...
                            <p>Identify your flaws and train on them with missions, fair challenges and pro
                                tutorials.</p>
                        </div>
                        <div className={styles.body}>
                            <div className={styles.icon}>
                ...
                return (
                    <div className={styles.visibility}>
                        <div className={styles.heading}>
                            <h1>Visibility:</h1>
                            <ReactSVG src={'/images/icons/underline.svg'}/>
                            <h3>Don’t Stay unnoticed Join our Leagues & Tournaments with agnostic ladder</h3>
                            <p>Play alongside streamers, pro players, and the stars of tomorrow in our streamed
                                competitions. Stand out to grow a community, get financed by them or hired.
                            </p>
                        </div>
                        <div className={styles.body}>
                ...
                return (
                    <div className={styles.earnings}>
                        <div className={styles.heading}>
                            <h1>Earnings:</h1>
                            <ReactSVG src={'/images/icons/underline.svg'}/>
                            <h3>Be rewarded for your efforts, perfomances andinvestments & kickstart your career or side hustle.</h3>
    ...
    return (
        <section className={styles.container}>
            ...
            <div className={styles.heading}>
                ...
                <p>Distortion provides the infrastructure to reinstate the thrill of the competition, improve your
                    skills, and get access to visibility & earnings.</p>
            </div>
